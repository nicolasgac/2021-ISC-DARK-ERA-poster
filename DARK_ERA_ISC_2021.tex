...
\begin{tabularx}{0.99\textwidth}{cc}
  \includegraphics[scale=0.95]{partenaires_DARK-ERA.eps} & \hspace{17cm}
   \scalebox{0.75}{ \input{logo_ANR_avec_numero_projet.pdf_t}}\\   
...
\footnotesize{
   ...
   %      \renewcommand{\bibsection}{}
         \bibliography{bib-dark-era,SimGrid,referencesCyril}   % bibliography data in report.bib
